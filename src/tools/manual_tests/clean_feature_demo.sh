...
echo ""
echo "Next steps:"
echo "  • Run pipeline: python -m src.cli.main pipeline --paper your_paper.pdf"
echo "  • Debug mode: python -m src.cli.main pipeline --paper your_paper.pdf --no-clean"
echo "  • Manual clean: python src/scripts/clean_intermediates.py --execute"
echo ""
