...
这个目录包含了 PaperReader 处理论文时产生的中间产物示例。
...
- **缓存文件内容** - 保存在 `runtime/cache/` 的 JSON 结构
...
这是一个经典的深度学习论文，非常适合展示 PaperReader 的功能。
...
3. **查看详细文档**
   - 阅读 `docs/architecture/DATA_FLOW.md`
   - 阅读 `docs/architecture/DATA_FLOW_QUICK_REFERENCE.md`
...
5. **检查输出**
   ```bash
   cat outputs/markdown/your_paper.md
   open outputs/slides/your_paper.html
   ```

## 相关文档

- [DATA_FLOW.md](../docs/architecture/DATA_FLOW.md) - 详细的数据流程
- [DATA_FLOW_QUICK_REFERENCE.md](../docs/architecture/DATA_FLOW_QUICK_REFERENCE.md) - 快速参考
